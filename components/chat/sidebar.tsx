...
import { Search, Settings, LogOut, MessageCircle, X, UserPlus } from "lucide-react"
      ...
      <div className="p-3 sm:p-4 border-b border-gray-200">
        <div className="flex items-center justify-between mb-3 sm:mb-4">
          ...
          <div className="flex space-x-1 sm:space-x-2">
            ...
            <Button variant="ghost" size="sm" className="hidden lg:flex" onClick={onLogoutClick}>
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="relative">
                  ...
                  <div
                    className={`absolute -bottom-1 -right-1 w-3 h-3 sm:w-4 sm:h-4 rounded-full border-2 border-white ${getStatusColor(contact.status)}`}
                  />
                </div>
                ...
                {contact.unreadCount > 0 && (
                  <Badge className="bg-blue-600 text-white text-xs px-1.5 py-0.5">{contact.unreadCount}</Badge>
                )}
              </div>
            </motion.div>
          ))}
